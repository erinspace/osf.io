...
class TestPreregFiles(AdminTestCase):
    def setUp(self):
        ...
        self.d_of_qs = {
            'q7': OsfStorageFileNode(target=self.node, name='7'),
            'q11': OsfStorageFileNode(target=self.node, name='11'),
            'q16': OsfStorageFileNode(target=self.node, name='16'),
            'q12': OsfStorageFileNode(target=self.node, name='12'),
            'q13': OsfStorageFileNode(target=self.node, name='13'),
            'q19': OsfStorageFileNode(target=self.node, name='19'),
            'q26': OsfStorageFileNode(target=self.node, name='26')
        }
        data = {}
